...
<div style="float: left; width: 100%;">
    ...
    <div style="float:left; margin-top: 20px; margin-left: 3%; width: 90%;" >
        ...
        <div id="user_dashboard" style="width: 100%">
            <iframe src="user.php" id="dashboard_iframe" scrolling="no" frameBorder="0" style="width: 100%; height: 300px;" onload="this.style.height=this.contentDocument.body.scrollHeight +'px';"></iframe>
        </div>
